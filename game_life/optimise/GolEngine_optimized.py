...
class GOLEngine:
    """
    Game of Life Engine with optimized performance and comprehensive statistics.
    """
    ...
    def randomize(self, percent=0.5):
        ...
        Args:
            percent: Threshold for cell death (higher = fewer living cells)
        """
    ...
    def fill(self, value=0):
        ...
        Args:
            value: 0 for dead cells, 1 for living cells
        """
        num = int(value == 1)
        self.__grid = [[num] * self.__height for _ in range(self.__width)]
